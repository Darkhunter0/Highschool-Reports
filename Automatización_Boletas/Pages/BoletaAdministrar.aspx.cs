...
{
    public partial class BoletaAdministrar : System.Web.UI.Page
    {
        int id_rol = 0;
        ...
        void Datos()
        {
            try
            {
                SqlCommand cmd = new SqlCommand("SELECT * FROM Boleta", con);
                con.Open();
        ...
        protected void btndelete_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/Pages/BoletaCRUD.aspx?id=" + id + "&op=D");
        }
        ...
        protected void btnupdate_Click(object sender, EventArgs e)
        {
            ...
            GridViewRow selectedrow = (GridViewRow)BtnConsultar.NamingContainer;
            id = selectedrow.Cells[1].Text;
            Response.Redirect("~/Pages/BoletaCRUD.aspx?id=" + id + "&op=U");
        }
        ...
        protected void btnread_Click(object sender, EventArgs e)
        {
            ...
            GridViewRow selectedrow = (GridViewRow)BtnConsultar.NamingContainer;
            id = selectedrow.Cells[1].Text;
            Response.Redirect("~/Pages/BoletaCRUD.aspx?id=" + id + "&op=R");
        }
        ...
        private void FiltrarDatos()
        {
            ...
            try
            {
                SqlCommand cmd = new SqlCommand("SELECT * FROM Boleta WHERE Profesor LIKE @SearchTerm OR Estado LIKE @SearchTerm OR Grupo LIKE @SearchTerm OR correo_electronico_usuario LIKE @SearchTerm", con);
